...
# Fully fixed CSS with readable text everywhere
st.markdown("""
    <style>
    .main {
        padding: 2rem;
    ...
    /* FIX CODE BLOCKS - LIGHT TEXT ON DARK BACKGROUND */
    code {
...
# Progress indicator
progress = min(st.session_state.step / 4, 1.0)  # Changed to 4 steps
...
# STEP 4: Final Check and Get Templates (REMOVED PLATFORM QUESTION)
